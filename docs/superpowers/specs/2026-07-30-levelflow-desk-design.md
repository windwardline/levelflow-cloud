...
18 / 18 / 12. Fills come from the app's real tokens (paper tile, ink
lines, accent entry; dark variant uses the dark-theme values) — the mark
IS the palette, never approximated hexes. It becomes the favicon set
