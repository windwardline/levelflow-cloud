...
> 2026-09-22. A revision inside the store's re-asked window, its newest stored
> date to today, supersedes the stored copy; an older one is never asked for.) Cost
