...
7. **Leftovers** (rank 13): ~~the Donate route while parked~~ (landed 2026-09-24, #705: the parking screen answers its own Donate); detecting an orphaned `confirm-4d` freeze; the rebuild logs pushed off-box; the recovery's scan speed.
