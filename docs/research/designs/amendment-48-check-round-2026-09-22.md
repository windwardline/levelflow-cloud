...
> it adopts ([`amendment-46-parameters-2026-09-21.md`](/docs/research/designs/amendment-46-parameters-2026-09-21.md))
> are records, not law; amendment 48 is not in the owner-rulings specs, and the branch
> that drafted it there (`docs/amendment-48`) did not merge. This file distils the check round that parked them, and
