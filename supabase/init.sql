...
-- Current LevelFlow no longer stores account-tracking data. Keep this cleanup at
-- the end so fresh bootstraps converge to the production schema after older
-- compatibility blocks above run.
